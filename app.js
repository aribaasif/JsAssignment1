...
// var marks3 = prompt("marks of third subject");
// var totalMarks =100;
// document.write("SUBJECT    TOTAL MARKS   OBTAINED MARKS    PERCENTAGE <br>");
// document.write(sub1 + ' \t ' + totalMarks + ' \t ' + marks1 + ' \t ' + (100*marks1)/totalMarks + "% <br>" );
// document.write(sub2 + totalMarks + marks2 + (100*marks2)/totalMarks + "% <br>" );
// document.write(sub3 + totalMarks + marks3 + (100*marks3)/totalMarks + "% <br>" );
